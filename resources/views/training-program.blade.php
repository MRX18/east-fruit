                    ...
                    <div class="col-sm-8 col-lg-9">
                        <div class="news-bredcrumbs-item">
                            <ul>
                                ...
                                <li><img src="../../images/page-item/Polygo-968.png" alt="/"></li>
                        ...
                        <div class="news-more-item">
                            ...
                            <div style="margin-top: 30px;" class="menu-calendar">
                                <ul>
                                    ...
                                    <li><a class="date-active"
                                           href="{{ route('training-program', ['id'=>$event->id]) }}">Программа</a></li>
                                    <li><a href="{{ route('training-organizer', ['id'=>$event->id]) }}">Организаторы</a>
                                    </li>
                                    <li><a href="{{ route('training-map', ['id'=>$event->id]) }}">Место проведения</a>
                                    </li>
                                </ul>
                            </div>

                            <h2 class="title-item">Программа</h2>
