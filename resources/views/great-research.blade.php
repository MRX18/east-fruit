                                        ...
                                        <div class="item-category">
                                            <div class="item item-category-image">
                                                <div class="item-hover">
                                                    <a href="{{ route('min-research', ['id'=>$articleCont->id_research]) }}" class="search"></a>
                                                </div>
                                            ...
                                            <div style="float: left;" class="title">
                                                <h4 style="text-align: left;"><a href="{{ route('min-research', ['id'=>$articleCont->id_research]) }}">{{ $articles->title.'-'.$articleCont->title }}</a></h4>
                                            </div>
