...
<div class="col-sm-8 col-lg-9">
    ...
    <div class="news-more-item">
        ...
        <div class="descr-item">
            ...
            <p>Проект осуществляется при поддержке Продовольсьвенной и сельскохозяйственной организации ООН (ФАО), Европейского банка реконструкции и развития (ЕБРР) и EU4Business, однако публикации на этом сайте не являются официальными материалами данных организаций, если иное не указано в тексте, и не обязательно отражают их позицию.</p>
        </div>
